...
def accept_connections():
    ...
    start = time.time()
    while time.time() - start < 60: #100s for peers to get their list or have a count of how many expected peers we have
        ...
        try:        
            ...
            print("Error while accepting connections:", sys.exc_info()[1])
            continue
